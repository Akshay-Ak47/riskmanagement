...
function RiskPage() {
   ...
   const [risk, setRisk] =
       useState<RiskState>(initialRiskState);
    const resetForm = () => {
    ...
    Select Attachment
            ...
            <div className="section-card">
                ...
                <div className="grid-container">
                    ...
                    <input
                        value="Risk Scope - AUTO GENERATED"
                        disabled
                    />
                    ...
                    <input
                        value="Risk Consequence Cost - AUTO GENERATED"
                        disabled
                    />
                    ...
                    <input
                        value="Risk Consequence Schedule - AUTO GENERATED"
                        disabled
                    />
            ...
            <div className="section-card">
                ...
                <div className="grid-container">
                    ...
                    <input
                        value="Date & Time - AUTO GENERATED"
                        disabled
                    />
